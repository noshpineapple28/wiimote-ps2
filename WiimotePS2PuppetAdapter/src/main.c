...
static service_characteristic_t characteristic_list[32] = {0};
...
int main()
{
    ...
    selection = -1;
    printf("Please select a service to read from: ");
    scanf("%d", &selection);
    ...
    printf("SELECTED: %s [] %s\n",
        characteristic_list[selection].service.value,
